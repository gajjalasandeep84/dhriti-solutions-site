  ...
  return (
    <section id="privacy-policy">
      ...
      <div style={{ padding: '3rem 2rem', maxWidth: '900px', margin: '0 auto', lineHeight: '1.8', fontSize: '1rem', color: '#334155' }}>
        ...
        <h2>Who We Are</h2>
        <p>Dhriti Solutions Inc. is a technology solutions provider specializing in software development, AI/ML services, data science, cybersecurity, coaching, consulting, and staffing solutions. Our headquarters is located in Cohoes, NY, USA.</p>
